            ...
            <?php if ($column_number < 3):  
              print $item; 
				...
				<div class="recomendados-grid-item">
				  ...
				  <div class="recomendados-imagen"><img typeof="foaf:Image" src="<?php print ($base_path . path_to_theme());  ?>/compass/images/logo-megainver.png"  width="260" height="200"  alt=""></div>
				</div>               
             <?php endif; ?>
          </td>
        <?php endforeach; ?>
